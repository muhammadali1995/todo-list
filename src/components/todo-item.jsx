...
export default function TodoItem({ todo }) {
    ...
    return <label className={`${todo.status === todoStatus.COMPLETE ? 'line-through border-gray-600 italic text-gray-500' : 'text-blue-500  border-blue-600'} border flex cursor-pointer items-center py-2 px-6 w-80 rounded-lg mt-5`}>
        <input type="checkbox"
        ...
        <p className="ml-2 font-medium w-full">{todo.text}</p>
    </label>
